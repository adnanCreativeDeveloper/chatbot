...
function LoginForm({
  ...
  const [invalidPasEmail, setInvalidPasEmail] = useState(false);
  const navigateToChatbot = useNavigate();
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzIzMjcxNjI2LCJpYXQiOjE3MjMxODUyMjYsImp0aSI6IjFlOGU3MWM0NTQyYzQ2YzE4OTA2YjkxMzI3YzJhYWE2IiwidXNlcl9pZCI6N30.tZgj0vs1kXkqoRNUZhj2gVZz81DUK80DhhQjs2m8cPw";
  ...
  async function handleLogin() {
    try {
      ...
      // console.log("Sending data for login:", payload);
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        data.access && navigateToChatbot("/chat-bot");
                ...
                <div className='mb-10'>
                  ...
                  {emailErr && (
                    <div className='flex gap-2 items-center pb-4'>
                      ...
                      <p className='text-red-600 text-sm'>Email is not valid</p>
